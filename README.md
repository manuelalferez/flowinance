...
Flowinance offers a suite of powerful features that simplify finance tracking:
...
Manage all your financial activities in one dashboard. Track expenses, categorize transactions, and gain insights from one place.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/manuelalferez/flowinance.git
   cd flowinance
   ```
...
- **Tailwind CSS**: For rapid and custom UI styling.
- **Supabase**: As the backend API for user authentication and transaction data management.
