  ...
  const featureCardDetails = [
    {
      ...
      description : "Manage your spending trends in real time with interactive charts and insights."
    },
    {
      icon : Upload,
      title : "Upload files",
      description : "Seamlessly upload your transactions from your bank in various formats, including CSV."
    },
    {
      icon : Brain,
      title : "Artificial Intelligence",
      description : "Leverage AI for smart transaction categorization and automated file cleaning."
    },
    {
      icon : Cloud,
      title : "Upload transactions",
      description : "Flexible options to upload transactions one by one or in bulk, tailored to your preference."
    },
    {
      icon : UserCircle2,
      title : "Authentication",
      description : "Secure authentication powered by Supabase, ensuring your data remains protected at all times."
    },
    {
      icon : Shield,
      title : "Security",
      description : "Bank-level encryption for all your information, with zero access to sensitive transaction details."
    }
  ]
